...
# mnist_img_path = "./data/MNIST_imgs"png
...
class ImageFolder(data.Dataset):
	...
	def load_img(self):
		...
		for i, img_name in enumerate(self.name_list):
			...
			path = self.img_path + "/" + img_name + ".jpg"
...
def load_attri(file_path):
	data_path = sorted(glob.glob('./data/img_align_celeba_png/*.jpg'))
	print(len(data_path))
	# get label
